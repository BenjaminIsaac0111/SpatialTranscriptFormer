...
def test_interaction_output_shape():
    ...
    assert output.shape == (4, num_genes), f"Expected shape (4, {num_genes}), got {output.shape}"
...
def test_interaction_gradient_flow():
    ...
    assert model.gene_reconstructor.weight.grad is not None, "No gradient in gene_reconstructor"
