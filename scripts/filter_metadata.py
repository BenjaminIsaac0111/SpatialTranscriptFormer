...
def filter_hest_metadata(csv_file, search_terms=['colon', 'rectum', 'colorectal', 'bowel']):
    bowel_samples = []
    ...
    with open(csv_file, 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            if any(term in organ for term in search_terms) or any(term in primary_site for term in search_terms):
